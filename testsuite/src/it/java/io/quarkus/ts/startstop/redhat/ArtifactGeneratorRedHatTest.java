...
public class ArtifactGeneratorRedHatTest extends ArtifactGeneratorTest {
    ...
    public void flowExtensions(TestInfo testInfo) throws Exception {
        smokeCheck(testInfo, SMOKE_CHECK_TYPE.COMMUNITY, flowExtensions, flowScannedDependencies, flowRedHatExcludes);
    }
    @Test
    public void camelExtensions(TestInfo testInfo) throws Exception {
        smokeCheck(testInfo, SMOKE_CHECK_TYPE.COMMUNITY, camelExtensions, camelScannedDependencies, emptyExcludes);
    }
}
