...
public enum CodeQuarkusExtensions {
    ...
    QUARKUS_REST_CLIENT_JAXB("quarkus-rest-client-jaxb", "REST Client JAXB", "8iY", false),
    QUARKUS_REST_CLIENT_JSONB("quarkus-rest-client-jsonb", "REST Client JSON-B", "Q3z", false),
    QUARKUS_REST_CLIENT_JACKSON("quarkus-rest-client-jackson", "REST Client Jackson", "pJg", false),
...
//  QUARKUS_SMALLRYE_JWT("quarkus-smallrye-jwt", "SmallRye JWT", "D9x", false),
    ...
    QUARKUS_GRPC("quarkus-grpc", "gRPC", "iDg", false),
...
//  QUARKUS_KEYCLOAK_AUTHORIZATION("quarkus-keycloak-authorization", "Keycloak Authorization", "2Bx", false),
    ...
    QUARKUS_SPRING_CACHE("quarkus-spring-cache", "Quarkus Extension for Spring Cache API", "DG", false),
    ...
    QUARKUS_SPRING_SCHEDULED("quarkus-spring-scheduled", "Quarkus Extension for Spring Scheduled ", "RUR", false),
