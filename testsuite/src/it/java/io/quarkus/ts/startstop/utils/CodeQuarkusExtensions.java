...
//    QUARKUS_REST_CLIENT_MUTINY("quarkus-resteasy-client-mutiny", "Mutiny support for REST Client", "Ph0", false),
//    QUARKUS_REST_CLIENT("quarkus-resteasy-client", "REST Client", "ekA", true),
//    QUARKUS_REST_CLIENT_JAXB("quarkus-resteasy-client-jaxb", "REST Client JAXB", "8iY", true),
//    QUARKUS_REST_CLIENT_JSONB("quarkus-resteasy-client-jsonb", "REST Client JSON-B", "Q3z", true),
//    QUARKUS_REST_CLIENT_JACKSON("quarkus-resteasy-client-jackson", "REST Client Jackson", "pJg", true),
