...
public enum MvnCmds {
    JVM(new String[][]{
            new String[]{"mvn", "-e", "clean", "dependency:tree", "compile", "quarkus:build", "-Dquarkus.package.output-name=quarkus"},
    ...
    NATIVE(new String[][]{
            Stream.concat(Stream.of("mvn", "-e", "clean", "compile", "package", "-Pnative"),
    ...
    MVNW_JVM(new String[][]{
        new String[]{Commands.mvnw(), "-e", "clean", "dependency:tree", "compile", "quarkus:build", "-Dquarkus.package.output-name=quarkus"},
        new String[]{"java", "-jar", "target/quarkus-app/quarkus-run.jar"}
    }),
    MVNW_NATIVE(new String[][]{
        Stream.concat(Stream.of(Commands.mvnw(), "-e", "clean", "dependency:tree", "compile", "package", "-Pnative", "-Dquarkus.package.output-name=quarkus"),
                getQuarkusNativeProperties().stream()).toArray(String[]::new),
