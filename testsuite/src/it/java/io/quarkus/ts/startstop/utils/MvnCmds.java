...
public enum MvnCmds {
    JVM(new String[][]{
            new String[]{"mvn", "-e", "-V", "clean", "dependency:tree", "compile", "quarkus:build", "-Dquarkus.package.output-name=quarkus"},
            new String[]{"java", "-jar", "target/quarkus-app/quarkus-run.jar"}
    }),
    DEV(new String[][]{
            new String[]{"mvn", "-e", "-V", "clean", "quarkus:dev", "-Dmaven.repo.local=" + getLocalMavenRepoDir()}
    }),
    NATIVE(new String[][]{
            Stream.concat(Stream.of("mvn", "-e", "-V", "clean", "compile", "package", "-Pnative"),
    ...
    MVNW_DEV(new String[][]{
            new String[]{Commands.mvnw(), "-e", "-V", "quarkus:dev"}
    }),
    MVNW_JVM(new String[][]{
        new String[]{Commands.mvnw(), "-e", "-V", "clean", "dependency:tree", "compile", "quarkus:build", "-Dquarkus.package.output-name=quarkus"},
        new String[]{"java", "-jar", "target/quarkus-app/quarkus-run.jar"}
    }),
    MVNW_NATIVE(new String[][]{
        Stream.concat(Stream.of(Commands.mvnw(), "-e", "-V", "clean", "dependency:tree", "compile", "package", "-Pnative", "-Dquarkus.package.output-name=quarkus"),
                getQuarkusNativeProperties().stream()).toArray(String[]::new),
