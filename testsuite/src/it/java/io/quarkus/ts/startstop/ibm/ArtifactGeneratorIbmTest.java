...
public class ArtifactGeneratorIbmTest extends ArtifactGeneratorTest {
    ...
    public void flowExtensions(TestInfo testInfo) throws Exception {
        smokeCheck(testInfo, SMOKE_CHECK_TYPE.PRODUCTIZED, flowExtensions, flowScannedDependencies, emptyExcludes);
    }
    @Test
    public void camelExtensions(TestInfo testInfo) throws Exception {
        smokeCheck(testInfo, SMOKE_CHECK_TYPE.PRODUCTIZED, camelExtensions, camelScannedDependencies, emptyExcludes);
    }
}
