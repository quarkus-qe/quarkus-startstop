...
```
./testsuite/target/archived-logs/io.quarkus.ts.startstop.StartStopTest/jakarta-restMinimalNative/native-build.log
./testsuite/target/archived-logs/io.quarkus.ts.startstop.StartStopTest/jakarta-restMinimalNative/native-run.log
...
./testsuite/target/archived-logs/io.quarkus.ts.startstop.StartStopTest/jakarta-restMinimalJVM/jvm-run.log
./testsuite/target/archived-logs/io.quarkus.ts.startstop.StartStopTest/jakarta-restMinimalJVM/jvm-build.log
...
```
# io.quarkus.ts.startstop.StartStopTest, jakarta-restMinimalJVM
